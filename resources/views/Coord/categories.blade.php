...
<body>
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-end">
            <a href="" id="a" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#createModal">Create
                new category</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-primary  btn-sm edit-btn"
                                data-categoryname="{{$category->name}}" data-categoryid="{{$category->id}}"
                                onclick="openEditModal(this)">Update</button>
                            <button class="btn btn-danger btn-sm edit-btn" onclick="openDeleteModal(this)"
                                data-categoryid="{{ $category->id }}">Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('Coord.createCategory',['id'=>$id]) }}" method="POST">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('Coord.updateCategory',['id'=>$id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="name" class="form-label">Name</label>
