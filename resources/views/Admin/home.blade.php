                ...
                <div class="modal-body">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="10" class="form-control" required id="phone" name="phone" pattern="\d{10}" title="Please enter a valid phone number" value="{{$user->phone}}" maxlength="10" />
