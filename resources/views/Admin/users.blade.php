            ...
            <table class="table table-striped table-bordered rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($user->id != 1)
                        <td>
                            <button class="btn btn-primary" onclick="openEditModal(this)" data-userid="{{ $user->id }}" data-username="{{ $user->name }}" data-useremail="{{ $user->email }}" data-userrole="{{ $user->role->name }}" data-userphone="{{ $user->phone }}">
                                Edit
                            </button>
                            <button class="btn btn-danger" onclick="openDeleteModal(this)" data-userid="{{ $user->id }}">
                                Delete
                            </button>
                        </td>
                        @endif
